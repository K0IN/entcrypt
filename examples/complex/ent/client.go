...
import (
	...
	"github.com/k0in/entcrypt/examples/complex/ent/migrate"
...
func (c *Client) Intercept(interceptors ...Interceptor) {
	c.PaymentMethod.Intercept(interceptors...)
...
// QueryOwner queries the owner edge of a PaymentMethod.
func (c *PaymentMethodClient) QueryOwner(_m *PaymentMethod) *UserQuery {
...
func (c *UserClient) QueryPaymentMethods(_m *User) *PaymentMethodQuery {
...
type (
	hooks struct {
		PaymentMethod, User []ent.Hook
	}
	inters struct {
		PaymentMethod, User []ent.Interceptor
	}
)

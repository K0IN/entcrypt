...
func (_q *UserQuery) QueryPaymentMethods() *PaymentMethodQuery {
...
func (_q *UserQuery) WithPaymentMethods(opts ...func(*PaymentMethodQuery)) *UserQuery {
	query := (&PaymentMethodClient{config: _q.config}).Query()
...
func (_q *UserQuery) loadPaymentMethods(ctx context.Context, query *PaymentMethodQuery, nodes []*User, init func(*User), assign func(*User, *PaymentMethod)) error {
